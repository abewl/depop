...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
  return (
    <>
      <Head title="Welcome" />
      <div id="main-wrapper"className="relative min-h-screen bg-gray-100 bg-center selection:bg-red-500 selection:text-white sm:flex sm:items-center sm:justify-center dark:bg-gray-900">

        <div id="member-section"
          className="p-6 text-end sm:fixed sm:right-0 sm:top-0">

          {auth.user ? (
            <Link href={route("dashboard")} className="font-semibold text-gray-600 hover:text-gray-900 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:text-gray-400 dark:hover:text-white">
              Dashboard
            </Link>
            ) : (
            <>
        ...
        <div id="margin-wrapper" className="mx-auto max-w-7xl p-6 lg:p-8">

          <div id="top-nav" className="flex justify-center">
            <div id="company-logo">
              <svg
                viewBox="0 0 62 65"
                fill="none"
          ...
          <div id="content-wrapper" className="mt-16">
          ...
          <div id="footer-wrapper" className="mt-16 flex justify-center px-6 sm:items-center sm:justify-between">
